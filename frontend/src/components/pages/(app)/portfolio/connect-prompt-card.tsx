...
export function ConnectPromptCard() {
  return (
    <motion.section
      ...
      className="flex flex-col items-center gap-4 rounded-3xl border border-main bg-surface px-6 py-16 text-center shadow-[0_16px_40px_rgba(0,0,0,0.35)]"
    >
      ...
      <div className="max-w-md">
        ...
        <p className="mt-2 text-sm text-muted">
          Yieldo reads real balances and earn positions directly from the
